...
> 朝起きてスマホを手に取ると、気づけば Twitter や Instagram のフィードをダラダラとスクロールしている。テック系の話題を収集しようとおもったのに、有名人のゴシップ、広告——こういった情報の洪水に飲まれ、気づけば時間が経っている・・・

なんてことはないでしょうか？

この**キャッチアップ疲れ**を解決したくて作ったのが 、この**tech-digest** 

**完成物**: https://hayatotoyoda.github.io/tech-digest/

毎朝 07:00 JST に GitHub Actions が自動実行し、[Hacker News](https://news.ycombinator.com/) (by [Y Combinator](https://www.ycombinator.com/)) のトップ記事を Claude AI が日本語でまとめ、GitHub Pages に公開する。サーバーレス・ゼロ運用コストで動いている。朝のルーティンが「1 ページを 2 分で読む」に変わる。
...
- [設計上の判断](#設計上の判断)
- [実装の核心](#実装の核心)
- [ハマった罠：GitHub Actions が 18 分フリーズした話](#ハマった罠github-actions-が-18-分フリーズした話)
- [セキュリティ強化：Red Team / Blue Team で自己レビュー](#セキュリティ強化red-team--blue-team-で自己レビュー)
- [TDD で書いたテスト](#tdd-で書いたテスト)
- [まとめ](#まとめ)
...
僕はキャッチアップをするつもりが、Twitterやインスタで時間を溶かしてしまう事が多いので、ニュースを届けてくれるAgentとして、このプロジェクトを今後も育てていきたいと思います。

自分だけのニュースAgent、育てがいがあって、楽しいです。
